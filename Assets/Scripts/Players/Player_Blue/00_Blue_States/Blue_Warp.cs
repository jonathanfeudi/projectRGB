...
public class Blue_Warp : MonoBehaviour
{
    ...
    void Update()   // State Transitions
    {
        ...
        if (altWarp == false)
        {
            if ((targetSwitch == 0) & ((Input.GetKeyDown("e")) || ((Input.GetAxis("LTrigger") > 0) & triggerDown == true)))
            {
            ...
            if ((targetSwitch == 1) & ((Input.GetKeyDown("e")) || ((Input.GetAxis("LTrigger") > 0) & triggerDown == true)))
            {
